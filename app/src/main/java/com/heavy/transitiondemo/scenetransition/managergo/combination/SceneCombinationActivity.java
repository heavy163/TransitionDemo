package com.heavy.transitiondemo.scenetransition.managergo.combination;
...
public class SceneCombinationActivity extends AppCompatActivity {
	...
	private void initData() {
		mSceneStart = Scene.getSceneForLayout(mSceneRootView, R.layout.scene_combination_start, mContext);
		mSceneEnd = Scene.getSceneForLayout(mSceneRootView, R.layout.scene_combination_end, mContext);
		/**
		 * 切换到开始场景状态
		 */
