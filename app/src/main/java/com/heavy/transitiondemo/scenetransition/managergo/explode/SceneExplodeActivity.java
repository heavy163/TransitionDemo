package com.heavy.transitiondemo.scenetransition.managergo.explode;
...
public class SceneExplodeActivity extends AppCompatActivity {
	...
	private void toggleScene() {
		TransitionManager.go(mStartSceneState ? mSceneEnd : mSceneStart, new Explode());
